...
struct Z_Construct_UClass_AMainGameMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MyInvenWidgetClass_MetaData[] = {
	...
	static const UECodeGen_Private::FClassPropertyParams NewProp_MyInvenWidgetClass;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AMainGameMode_Statics::NewProp_MyInvenWidgetClass = { "MyInvenWidgetClass", nullptr, (EPropertyFlags)0x0044000000000015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMainGameMode, MyInvenWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UMyInvenWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MyInvenWidgetClass_MetaData), NewProp_MyInvenWidgetClass_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMainGameMode_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMainGameMode_Statics::NewProp_MyInvenWidgetClass,
};
...
struct Z_CompiledInDeferFile_FID_UE5_Character_02_Source_UE5_Character_02_MainGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMainGameMode, AMainGameMode::StaticClass, TEXT("AMainGameMode"), &Z_Registration_Info_UClass_AMainGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMainGameMode), 1597242366U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Character_02_Source_UE5_Character_02_MainGameMode_h_194526120(TEXT("/Script/UE5_Character_02"),
